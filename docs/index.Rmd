...
```{r include=T}
#Snail plot/
knitr::include_graphics('/Users/solracarias/Dropbox/Panama-Geminate-Project/docs/p_colonus_blob_results/linear_plot.png')
```

```{r include=T}
#Snail plot/
knitr::include_graphics('/Users/solracarias/Dropbox/Panama-Geminate-Project/docs/p_colonus_blob_results/log_plot.png')
```
...
```{r include=T}
#Snail plot/
knitr::include_graphics('/Users/solracarias/Dropbox/Panama-Geminate-Project/docs/p_furcifer_blob_results/linear_plot.png')
```

```{r include=T}
#Snail plot/
knitr::include_graphics('/Users/solracarias/Dropbox/Panama-Geminate-Project/docs/p_furcifer_blob_results/log_plot.png')
```
...
```{r include=T}
#Snail plot/
knitr::include_graphics('/Users/solracarias/Dropbox/Panama-Geminate-Project/docs/c_fulva_blob_results/linear_plot.png')
```

```{r include=T}
#Snail plot/
knitr::include_graphics('/Users/solracarias/Dropbox/Panama-Geminate-Project/docs/c_fulva_blob_results/log_plot.png')
```
...
```{r include=T}
#Snail plot/
knitr::include_graphics('/Users/solracarias/Dropbox/Panama-Geminate-Project/docs/c_multilineata_blob_results/linear_plot.png')
```

```{r include=T}
#Snail plot/
knitr::include_graphics('/Users/solracarias/Dropbox/Panama-Geminate-Project/docs/c_multilineata_blob_results/log_plot.png')
```
...
```{r include=T}
#Snail plot/
knitr::include_graphics('/Users/solracarias/Dropbox/Panama-Geminate-Project/docs/c_atrilobata_blob_results/linear_plot.png')
```

```{r include=T}
#Snail plot/
knitr::include_graphics('/Users/solracarias/Dropbox/Panama-Geminate-Project/docs/c_atrilobata_blob_results/log_plot.png')
```
...
```{r include=T}
#Snail plot/
knitr::include_graphics('/Users/solracarias/Dropbox/Panama-Geminate-Project/docs/c_cynea_blob_results/linear_plot.png')
```

```{r include=T}
#Snail plot/
knitr::include_graphics('/Users/solracarias/Dropbox/Panama-Geminate-Project/docs/c_cynea_blob_results/log_plot.png')
```
...
```{r include=T}
#Snail plot/
knitr::include_graphics('/Users/solracarias/Dropbox/Panama-Geminate-Project/docs/a_troshelii_blob_results/linear_plot.png')
```

```{r include=T}
#Snail plot/
knitr::include_graphics('/Users/solracarias/Dropbox/Panama-Geminate-Project/docs/a_troshelii_blob_results/log_plot.png')
```
